...
const SignUpPage = () => {
  return (
    <>
      <Helmet>
        <title>Sign Up - JGM Innovation</title>
        <meta name="description" content="Create an account with JGM Innovation to access data science tools and insights." />
        <link rel="canonical" href="https://jgm-innovation.com/signup" />
        {/* Open Graph / Facebook */}
        <meta property="og:title" content="Sign Up - JGM Innovation" />
        <meta property="og:description" content="Create an account with JGM Innovation to access data science tools and insights." />
        <meta property="og:url" content="https://jgm-innovation.com/signup" />
        {/* Twitter */}
        <meta name="twitter:title" content="Sign Up - JGM Innovation" />
        <meta name="twitter:description" content="Create an account with JGM Innovation to access data science tools and insights." />
      </Helmet>
